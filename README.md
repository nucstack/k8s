...
[![k3s](https://img.shields.io/badge/k3s-v1.21.3-orange?style=for-the-badge&logo=kubernetes)](https://k3s.io/)
...
## K8S@Home Deployment
Originally based off [this](https://github.com/k8s-at-home/template-cluster-k3s) template. Most of the decisions came from the fantastic list of projects [here](https://github.com/k8s-at-home/awesome-home-kubernetes).

Main Deviations from this template:
 - Added a devcontainer image with all deps to simplify interaction within vscode.
 - Added tasks to simplify deployment/bootstrap/initialize/secrets reroll.
 - Added checkov to add some code analysis for defined infrastructure.
